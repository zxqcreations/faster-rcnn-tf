...
class Network(object):
  ...
  def test_image(self, sess, image, im_info):
    ...
    #print('cls_prob:', type(self._predictions['cls_prob']), cls_prob.shape)
    #print('bbox_pred:', type(self._predictions['bbox_pred']), bbox_pred.shape)
    #print('rois:', type(self._predictions['rois']), rois.shape)
    #con = tf.concat([self._predictions["cls_score"], self._predictions['cls_prob'], self._predictions['bbox_pred'], self._predictions['rois']], 1, name='concat')
    #print('con:', con.shape)
