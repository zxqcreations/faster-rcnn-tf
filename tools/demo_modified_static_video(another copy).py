...
def vis_detections(im, im2, dets, thresh=0.5):
    ...
    if not tmp_frm == []:
        ...
        cv2.imwrite('/home/sook/code/newImgs/obj_{:s}.jpg'.format(str(cur_ind).zfill(4)), t_im)
...
if __name__ == '__main__':
    ...
    #                          NETS[demonet][0])
    model_path = '/home/sook/code/faster-rcnn-tf/output/vgg16/voc_2007_trainval/default/'
    tfmodel = model_path + 'vgg16_faster_rcnn_iter_70000.ckpt'#.data-00000-of-00001'
    ...
    cap = cv2.VideoCapture('/home/sook/code/videosource/out_inf4.avi')
    cap_inf = cv2.VideoCapture('/home/sook/code/videosource/out4.avi')
    path = '/home/sook/code/new_imgSet/'
    imgs = os.listdir(path)
    # if you cannot connect to your camera, try to change this value, e.g., change 0 to 1

    for d, i in enumerate(imgs):
        img = cv2.imread(path+i)
        img_inf = cv2.imread(path+i)
    ...
    with open('/home/sook/code/newImgs.json', 'w') as f:
        f.write(js_str)
    print(tags_name)
    cap.release()
    cap_inf.release()
